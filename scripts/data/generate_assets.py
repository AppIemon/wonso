...
def main() -> None:
    ...
    ko = {
        ...
        "message.wonso.refine_ok": "공정 완료: %s",
        "message.wonso.purified": "순화 완료: %s",
        "message.wonso.fusion_missing": "핵융합 재료 카드가 부족합니다",
        "message.wonso.fusion_ok": "핵융합 성공: %s",
        "message.wonso.star_ok": "별 점화: %s",
        "message.wonso.battle_none": "진행 중인 대전이 없습니다",
        "message.wonso.party_empty": "파티가 비어 있습니다",
        "message.wonso.battle_start": "원소 신전 대전 시작",
    ...
    en = {
        ...
        "message.wonso.refine_ok": "Process done: %s",
        "message.wonso.purified": "Purified %s",
        "message.wonso.fusion_missing": "Missing fusion cards",
        "message.wonso.fusion_ok": "Fused %s",
        "message.wonso.star_ok": "Star: %s",
        "message.wonso.battle_none": "No battle",
        "message.wonso.party_empty": "Party is empty",
        "message.wonso.battle_start": "Shrine battle started",
        "key.categories.wonso": "wonso",
